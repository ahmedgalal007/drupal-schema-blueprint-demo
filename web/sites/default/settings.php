...
set_error_handler(function($errno, $errstr) {
  if ($errno === E_DEPRECATED && str_contains($errstr, 'Passing null to parameter')) {
    return true; // Ignore this specific deprecation
  }
  return false; // Let PHP handle everything else normally
});*/
